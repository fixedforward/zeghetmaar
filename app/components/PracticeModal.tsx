...
export function PracticeModal(props: Props) {
  const { isOpen, currentPhrase, extraWords, prompt, promptLoading, userAnswer, setUserAnswer, evaluation, evaluationLoading, close, regeneratePrompt, submitAnswer } = props
