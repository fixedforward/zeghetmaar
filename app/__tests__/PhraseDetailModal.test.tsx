...
const entry: WordEntry = {
  ...
  word: 'gezellig',
  translation: 'cozy',
  examples: ['Het was een gezellige avond — It was a cozy evening'],
  tags: ['sfeer'],
  beheersing: 2,
  isFavorite: false,
...
function buildProps(overrides: Partial<Props> = {}): Props {
  return {
    ...
    setEditTranslation: vi.fn(),
    editExamples: [...entry.examples],
    setEditExamples: vi.fn(),
    editTags: ['sfeer'],
    setEditTags: vi.fn(),
    editLoading: false,
